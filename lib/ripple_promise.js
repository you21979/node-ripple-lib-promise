...
var mergeOption = function(params, opt){
...
var accountLines = exports.accountLines = function(remote, address, opt){
    if(!opt) opt = {};
    return createRequest(function(){
        return remote.requestAccountLines(mergeOption({
            account : address,
        }, opt));
    })
}
...
var accountTransactions = exports.accountTransactions = function(remote, address, params){
    if(!params) params = {};
    return createRequest(function(){
        return remote.requestAccountTransactions({
            account : address,
            ledger_index_min: params.ledger_index_min ? params.ledger_index_min : -1,
            ledger_index_max: params.ledger_index_max ? params.ledger_index_max : -1,
            binary: false,
